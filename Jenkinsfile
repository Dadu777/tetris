...
pipeline {
    ...
    environment {
        ...
        dockerImage = "851725361294.dkr.ecr.us-east-1.amazonaws.com/${repoName}"
    ...
    stages {
        ...
        stage('Kubernetes Deploy - DEV') {
            ...
            steps {
                kubernetesEKSHelmDeploy('$dockerImage', '$dockerTag', '$repoName', 'awsCred', 'us-east-1', 'dpr', 'dev')
            }
        }
        ...
        stage('Kubernetes Deploy - UAT') {        
            ...
            steps {
                kubernetesEKSHelmDeploy('$dockerImage', '$dockerTag', '$repoName', 'awsCred', 'us-east-1', 'dpr', 'uat')
            }
        }
